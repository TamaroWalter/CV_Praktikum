...
Algorithmus:
1. Schritt: Jpg zu grauwerte-Matrix umwandeln
2. Schritt: Mit Sobel-Operator Kantenstärke ermitteln
3. Schritt: Richtung der Kanten bestimmen
...
gray_value_matrix = cv2.imread(path[0], cv2.IMREAD_GRAYSCALE)
print(gray_value_matrix[:5, :5])
